...
**Generated by:** `02_Analysis/1.1.main_pipeline.R` and related scripts
...
|------|------|-------------|--------------|
| `model_objects.rds` | 22 MB | Complete limma model (fit, voom, design) | 1.1.main_pipeline.R |
| `DGE_object.rds` | 1.3 MB | edgeR DGEList with counts and normalization | 1.1.main_pipeline.R |
| `voom_object.rds` | 5.8 MB | voom-transformed expression matrix | 1.1.main_pipeline.R |
| `fit_object.rds` | 14 MB | Fitted limma linear model | 1.1.main_pipeline.R |
| `contrasts_matrix.rds` | 281 B | Contrast definitions matrix | 1.1.main_pipeline.R |

### Differential Expression Results

| File | Size | Description | Generated By |
|------|------|-------------|--------------|
| `contrast_tables.rds` | 7.9 MB | All DE tables (9 contrasts) | 1.1.main_pipeline.R |
| `de_results.rds` | 162 KB | decideTests results (up/down flags) | 1.1.main_pipeline.R |

### GSEA Results

| File | Size | Description | Generated By |
|------|------|-------------|--------------|
| `all_gsea_results.rds` | 82 MB | MSigDB GSEA (all databases, all contrasts) | 1.1.main_pipeline.R |
| `syngo_gsea_results.rds` | 2.4 MB | SynGO GSEA results | 1.1.main_pipeline.R |
| `syngo_lists.rds` | 13 KB | SynGO TERM2GENE and TERM2NAME | 1.1.main_pipeline.R |
| `mitocarta_gsea_results.rds` | 2.4 MB | MitoCarta GSEA results | 1.3.add_mitocarta.R |

### Quality Control & Annotation

| File | Size | Description | Generated By |
|------|------|-------------|--------------|
| `qc_variables.rds` | 2.1 MB | Sample annotations, colors, ordered samples | 1.1.main_pipeline.R |
| `gene_intersections.rds` | 207 B | Shared DE genes between mutations | 1.1.main_pipeline.R |

### Module Analysis

| File | Size | Description | Generated By |
|------|------|-------------|--------------|
| `gsva_module_scores.rds` | 4.6 KB | GSVA pathway scores per sample | 2.4.viz_critical_period_trajectories_gsva.R |
...
- `02_Analysis/1.1.main_pipeline.R` - Checkpoint generation code
