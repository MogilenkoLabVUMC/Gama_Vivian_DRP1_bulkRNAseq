...
**Generator Script:** `02_Analysis/3.1.publication_figures.py`
...
| `2.2.viz_mito_translation_cascade.R` | Mechanistic flow heatmap | `Mito_translation_cascade/` |
...
| `2.3.viz_synaptic_ribosomes.R` | Compartment-specific expression | `Synaptic_ribosomes/` |
