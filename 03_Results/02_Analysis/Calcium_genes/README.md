...
**Generated by:** `02_Analysis/2.6.viz_calcium_genes.R` (sourced from `1.1.main_pipeline.R`)
...
The analysis is performed by `02_Analysis/2.6.viz_calcium_genes.R`, which is sourced from the main pipeline:
...
- `02_Analysis/2.6.viz_calcium_genes.R` - Generation script
